_base_ = [
    "../_base_/datasets/activitynet-1.3/features_i3d_resize_trunc.py",  # dataset config
    "../_base_/models/actionformer.py",  # model config
]

annotation_path = "data/activitynet-1.3/annotations/anet_0.1.json"
